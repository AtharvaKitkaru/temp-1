        ...
        render() {
            return ( 
                <div className="container p-3 shadow-sm text-center">
                   <div>
                       <p className = "" style={{fontWeight:"500",fontSize:"1.2em"}}>Upload Documents</p>
                   </div>
                   ...
                   <Form  style={{fontSize:"0.8em"}}>
                        <Form.Group className = "border border-light p-2">
                                ...
                                {/* Custom file button */}
                                <Button id= "input-btn"size = "sm" className="w-75" variant="light" onClick = {this.inputFile}>Attach file</Button>
                        ...
                        <Button size = "sm" type = "submit" block style={{backgroundColor:"rgb(183, 32, 46)"}}>Submit documents</Button>                            
                    </Form>
                </div>
            )
        }
